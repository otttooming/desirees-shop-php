                    ...
                    foreach ( $attachment_ids as $id ) {
                        ...
                        <figure class="swiper-slide product__image-object" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                            <a href="<?php echo wp_get_attachment_image_src( $id, 'full' )[0]; ?>" itemprop="contentUrl" data-size="<?php echo $img[1] . 'x' . $img[2] ?>">
                                <img data-src="<?php echo wp_get_attachment_image_src( $id, 'medium' )[0]; ?>" class="product__image lazyload" itemprop="thumbnail" width="<?php echo wp_get_attachment_image_src( get_post_thumbnail_id(), 'medium' )[1] ?>" height="<?php echo wp_get_attachment_image_src( get_post_thumbnail_id(), 'medium' )[2] ?>">
                            </a>
                        </figure>
